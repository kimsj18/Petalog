      ...
      <div className="min-h-screen">
        ...
        <Container size="narrow">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <Shield className="size-5 text-gray-400 flex-shrink-0" />
              <div className="flex-1">
            ...
            <div className="flex items-center gap-3">
              <Package className="size-5 text-gray-400 flex-shrink-0" />
              <div className="flex-1">
        ...
        <Container size="narrow">
          ...
          {selectedTab === 'info' && (
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-lg text-gray-900 mb-4">추천 대상</h2>
                <div className="space-y-2">
                  {product.bestFor.map(target => (
                    <div
                      key={target}
                      className="flex items-start gap-2 p-3 bg-gray-50 rounded-lg"
                    >
                      <AlertCircle className="size-5 text-gray-400 flex-shrink-0 mt-0.5" />
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700">
                      해당 제품은 {product.ingredients[0]}을(를) 포함하고 있습니다. 
                      알러지가 있는 반려견은 주의해주세요.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6">
                <div className="text-center mb-4">
                  <div className="text-4xl text-blue-900 mb-2">{product.rating}</div>
